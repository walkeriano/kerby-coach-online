  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-yellow-400 text-slate-900 hover:bg-yellow-400 hover:text-slate-900 focus:bg-yellow-400 focus:text-slate-900 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today: "bg-yellow-50 text-slate-900 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
